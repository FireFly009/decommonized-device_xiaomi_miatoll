...
static const variant_info_t curtanain_info = {
    ...
    .build_fingerprint = "Redmi/curtana_in1/curtana:12/RKQ1.211019.001/V14.0.4.0.SJWMIXM:user/release-keys",
...
static const variant_info_t joyeuse_info = {
    ...
    .model = "Redmi Note 9 Pro",
    .build_fingerprint = "Redmi/joyeuse_global/joyeuse:12/RKQ1.211019.001/V14.0.3.0.SJPINXM:user/release-keys",
